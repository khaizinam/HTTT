                        ...
                        if($count > 0)
                        {
                            while($row = mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr class="res d-none">
                                    ...
                                    <td><a href="<?php echo SITE_URL; ?>show.php?id=<?php echo $product_id; ?>" class="text-decoration-none product-name"><?php echo $product_name; ?></a></td>
                                    <td><?php echo $product_description; ?></td>
                                    <td><?php echo $product_type; ?></td>
                                    <td><?php echo $product_quantity; ?></td>
                                    <td>
                                        <a href="<?php echo SITE_URL; ?>edit-product.php?id=<?php echo $product_id; ?>" class="btn btn-primary" type="button">Edit Product</a>
                                        <a href="<?php echo SITE_URL; ?>delete-product.php?id=<?php echo $product_id; ?>" class="btn btn-danger" type="button">Delete Product</a>
                                    </td>
                                </tr>
                                <?php
                            }
