...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/clerk.css">
</head>
<body>
<?php 
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="text-right">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a type="button" href="../../admin/staff.php" class="btn btn-secondary">Cancel</a>
                                    <?php
                                }
                                else
                                {
                                    ?>
                                    <a type="button" href="../../home.php" class="btn btn-secondary">Cancel</a>
                                    <?php
                                }
                            ?>
