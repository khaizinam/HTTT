<?php include('../../assets/inc/header.php'); ?>
    ...
    <div class="container-xl border" style="margin-top: 10px;">
        ...
        <div class='table-responsive-xl'>
            ...
            <form action="../confirm/confirm-import.php">
...
<script>
    ...
    function removeCart(e) {
        ...
        xhr.open("POST", "../remove/remove-import.php");
        xhr.onload = ()=>{
    ...
    function input_change(t){
        ...
        console.log(id);
        let xhr = new XMLHttpRequest();
            xhr.open("GET", "../page/input-change.php?id=".concat(id)+"&quantity=".concat(check),true);
            xhr.onload = ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
    ...
    function addItem(id)
    {
        ...
        let xhr = new XMLHttpRequest();
            xhr.open("GET", "../cart/cart-item.php?id=".concat(id),true);
            xhr.onload = ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
