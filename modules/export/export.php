<?php include('../../config/connect.php'); ?>
    <div class="container-fluid">
        <h3 class='text-center'>Export Form</h3>
        <a href="<?php echo SITE_URL; ?>order.php"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 30px;"></i></a> 
    </div>
    ...
    <div class="container-xl border" style="margin-top: 10px;">
        ...
        <div class='table-responsive-xl'>
            ...
            <form action="../confirm/confirm-export.php">
...
<script>
    ...
    function removeCart(e) {
        ...
        xhr.open("POST", "../remove/remove-export.php");
        xhr.onload = ()=>{
    ...
    function addItem(id)
    {
        ...
        let xhr = new XMLHttpRequest();
                xhr.open("GET", "../cart/cart-exported-item.php?id=".concat(id),true);
                xhr.onload = ()=>{
                    if(xhr.readyState === XMLHttpRequest.DONE){
                        if(xhr.status === 200){
                            let data = xhr.response;
    ...
    function decTotal(t){
        ...
        if(check >= 1){
            ...
            form = t.parentElement.querySelector(".quantityForm");
            let xhr = new XMLHttpRequest();
                xhr.open("POST", "../dec/dec-exported.php");
                xhr.onload = ()=>{
                    if(xhr.readyState === XMLHttpRequest.DONE){
                        if(xhr.status === 200){
                            let data = xhr.response;
