<?php include('../../assets/inc/header.php')?>
    ...
    ?>
        <h4>Product</h4>
        <button class="btn btn-success"><a href="../add/add-product.php" class="text-decoration-none text-white"><i class="fa fa-plus-circle" style="font-size: 23px; padding-right: 5px;"></i>Add new Product</a></button>
                        ...
                        if($count > 0)
                        {
                            while($row = mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr class="res d-none">
                                    ...
                                    <td><a href="../show/show.php?id=<?php echo $product_id; ?>" class="text-decoration-none product-name"><?php echo $product_name; ?></a></td>
                                    <td><?php echo $product_description; ?></td>
                                    <td><?php echo $product_type; ?></td>
                                    <td><?php echo $product_quantity; ?></td>
                                    <td>
                                        <a href="../edit/edit-product.php?id=<?php echo $product_id; ?>" class="btn btn-primary" type="button">Edit Product</a>
                                        <a href="../page/delete-product.php?id=<?php echo $product_id; ?>" class="btn btn-danger" type="button">Delete Product</a>
                                    </td>
                                </tr>
                                <?php
                            }
