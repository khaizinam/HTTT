...
?>
    <div class="container-fluid">
        ...
        <a href="<?php echo SITE_URL; ?>product.php"><i class="fa fa-arrow-left" aria-hidden="true" style="font-size: 30px;"></i></a>
    </div>
    ...
    <div class="container-xl border" style="margin-top: 10px;">
        ...
        ?>
        <h4>Items</h4>
        <button class="btn btn-success"><a href="<?php echo SITE_URL; ?>add-item.php?product_id=<?php echo $product_id; ?>" class="text-decoration-none text-white"><i class="fa fa-plus-circle" style="font-size: 23px; padding-right: 5px;"></i>Add new Item</a></button>
